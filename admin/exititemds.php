...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>exit Item Dropshipper</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="stokall.php">Home</a></li>
          <li class="breadcrumb-item active">Exit Item Dropshipper</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Input Exit DS</h5>
                  ...
                  <form class="row g-3" method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                      <button type="submit" name="exitds" class="btn btn-primary">Submit</button>
