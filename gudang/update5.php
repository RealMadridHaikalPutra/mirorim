...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="updatebarang.php">Home</a></li>
          <li class="breadcrumb-item active">Update Item 5</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Update Item 5</h5>
                  ...
                  <form class="row g-3" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" class="form-control" id="floatingQuantity" name="gudang" value="5">
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <select class="form-select" name="worker" id="floatingSelect" aria-label="State">
                          <option selected>--</option>
                          <option value="Dhani">Dhani</option>
                          <option value="Ilham">Ilham</option>
                          <option value="Zaldi">Zaldi</option>
                          <option value="Rey">Rey</option>
                          <option value="Ayung">Ayung</option>
                        </select>
                        <label for="floatingSelect">Worker</label>
                      </div>
                    </div>
                    <div class="text-center">
                      <button type="submit" name="update5" class="btn btn-primary">Submit</button>
