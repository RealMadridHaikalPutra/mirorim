...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="barangkeluar.php">Home</a></li>
          <li class="breadcrumb-item active">Exit Item 5</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Exit Item 5</h5>
                  ...
                  <form class="row g-3" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4">
                      <div class="form-floating">
                        <input type="text" class="form-control text-uppercase" id="floatingName" name="picker" placeholder="Picker">
                        <label for="floatingName">Picker</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <select class="form-select" name="status" id="floatingSelect" aria-label="State">
                    ...
                    <div class="text-center">
                      <button type="submit" name="exit5" class="btn btn-primary">Submit</button>
