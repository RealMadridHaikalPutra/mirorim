...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add New Item 5</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="gudang.php">Home</a></li>
          <li class="breadcrumb-item active">Add New Item 5</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Input New Item 5</h5>
    
                  <!-- Floating Labels Form -->
                  <form class="row g-3" method="post" enctype="multipart/form-data">
                    <div class="col-md-6">
                      <div class="form-floating">
                        <input type="text" class="form-control" id="floatingName" name="nama" placeholder="Item Name">
                    ...
                    <div class="text-center">
                      <button type="submit" name="addnew5" class="btn btn-primary">Submit</button>
