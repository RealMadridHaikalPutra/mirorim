    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="updatebarang5.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update Item Masuk 5</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="card">
              <div class="card-body">
                <div class="card-title">
                    <h5>Update Barang 5 Existing</h5>
                    ...
                    <a class="btn btn-outline-danger" type="button" href="update.php">
                      <i class="bi bi-trash-fill"></i> Delete All History G5
                    </a>
                </div>
              ...
              <table class="table table-striped" >
                ...
                <tbody  data-bs-toggle="modal" data-bs-target="#smallModal<?=$idb;?>">
                  <?php
                    $ambilduatabel = mysqli_query($koneksi, "SELECT * FROM updateitem5 INNER JOIN stok5 ON updateitem5.skutoko = stok5.skutoko");
                    $i = 1;
